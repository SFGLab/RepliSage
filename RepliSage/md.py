...
class MD_LE:
    ...
    def run_pipeline(self,run_MD=True,sim_step=1,write_files=False):
        '''
        ...
        integrator = mm.LangevinIntegrator(310, 0.1, 10 * mm.unit.femtosecond)
        ...
        self.simulation.reporters.append(DCDReporter(self.out_path+'/other/stochastic_LE.dcd', (self.N_steps*sim_step)//100))
