...
args = ListOfArgs([
    ...
    Arg('T_INIT', help="Initial temperature for the stochastic model.", type=float, default='2.0', val='2.0'),
    Arg('T_FINAL', help="Final temperature for the stochastic model.", type=float, default='1.0', val='1.0'),
    Arg('METHOD', help="Stochastic modeling method: 'Metropolis' or 'Simulated Annealing'.", type=str, default='Annealing', val='Annealing'),
