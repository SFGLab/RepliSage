...
args = ListOfArgs([
    ...
    Arg('EPI_INTERACT_COEFF', help="Interaction coefficient for the epigenetic node state model.", type=float, default='1.0', val='1.0'),
    Arg('EPI_FIELD_COEFF', help="Eigenetic field coefficient for the epigenetic node state model.", type=float, default='1.0', val='1.0'),
